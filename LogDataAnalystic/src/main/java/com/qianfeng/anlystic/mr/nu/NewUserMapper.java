...
public class NewUserMapper extends TableMapper<StatsUserDimension,TimeOutputValue>{
    ...
    private KpiDimension newUserKpi = new KpiDimension(KpiType.NEW_INSTALL_USER.kpiName);
    private KpiDimension browserNewUserKpi = new KpiDimension(KpiType.BROWSER_NEW_INSTALL_USER.kpiName);
